		...
		<div class="container">
			<section class="content-inner margin-top-no">
				<div class="row">
					...
					{if $pmw!=''}
                    <form id="myForm" action="/php/post.php" method="post">
					<div class="col-lg-12 col-md-12">
						<div class="card margin-bottom-no">
							<div class="card-main">
								<div class="card-inner">
...
<option value="15">15元-[VIP1一月]</option>
<option value="20">20元-[VIP2一月]</option> 
<option value="25">25元-[VIP3一月]</option>
<option value="30">30元-[VIP4一月]</option>
<option value="45">45元-[VIP1一季]</option>
<option value="60">60元-[VIP2一季]</option> 
<option value="75">75元-[VIP3一季]</option> 
<option value="90">90元-[VIP4一季]</option> 
<option value="80">80元-[VIP1半年]</option>
<option value="110">110元-[VIP2半年]</option>
<option value="140">140元-[VIP3半年]</option> 
<option value="170">170元-[VIP4半年]</option> 
<option value="128">128元-[VIP1一年]</option> 
<option value="188">188元-[VIP2一年]</option>    
<option value="248">248元-[VIP3一年]</option>
<option value="308">308元-[VIP4一年]</option>                          
						</select>
						<p></p>
						<a class="btn btn-flat waves-attach waves-effect" id="cz"><span class="icon">check</span>&nbsp;充值</a>
